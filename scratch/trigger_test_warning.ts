...
async function run() {
  const installmentId = 'cbb9d3e0-a612-4834-a7c5-90a3da8f32ec'; // Henrique's installment
  ...
  const remoteJid = cleanPhone.startsWith('55') ? `${cleanPhone}@s.whatsapp.net` : `55${cleanPhone}@s.whatsapp.net`;
  ...
  console.log(`[Billing Webhook] Sending payload to n8n:`, n8nWebhookUrl);
