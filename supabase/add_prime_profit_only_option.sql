-- 1. Adicionar coluna na tabela devices para armazenar o tipo de repasse (percent, fixed, profit_only)
ALTER TABLE devices ADD COLUMN IF NOT EXISTS prime_profit_share_type TEXT DEFAULT 'percent';

-- 2. Atualizar a função do trigger do banco de dados para suportar o tipo de repasse 'profit_only'
...
DECLARE
    ...
    v_prime_profit_share_type TEXT; -- Nova variável para armazenar o tipo de repasse
